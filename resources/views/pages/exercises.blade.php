          ...
          <div class="flex-caption">
            ...
            <div class="card">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title home-title-section">Colour match</h5>
                    <p class="card-text" style="font-family:Serif,Cabin Sketch">The colour match game is based on stroop test.The Stroop Color Test is designed to measure the ability to inhibit a prepotent reading response . When used with children, the test can also provide information regarding the development and dominance of the reading system. 
                    </p>
                  </div>
                  <div class="card-footer">

...
<head>
 ...
 #div1 {
  font-size:48px; }
     ...
     canvas{ animation: mymove 5s infinite;  border: 5px solid   #0a3cda  ; border-style:solid; border-radius: 15px 15px; align-content: center; }
     @keyframes mymove {
...
.close{
 ...
 <body style="background:url({{asset('images/bkg.svg')}}) repeat scroll center center #E9F8FC;">
     <h2><b><center>Flappy Bird !<div id="div1" class="fa"></div> </center></b></h2>
     <!-- <h3><b>If you want to have a very high score. Think out of this game !!  ~_^ <hr> and tell me your high score </b></h3> -->
     <div id="box">
    <!-- <span class="ion-checkmark-round"></span> -->
    <p style="font-size:15px">Wanna beat yourself?</p>
    <p style="font-size:15px">Play again!!</p>
    <a class="close">Close</a>
</div>
<div style="padding-left:20px">
<canvas id="myCanvas" width=300 height=480
 style="background:url('http://s2js.com/img/etc/flappyback.png');  background-size: 100%; height: 80% ;" 
</canvas>
    <h3><center> <i onclick="myFunction(this)" class="fa fa-thumbs-up"></i></center></h3>
    </div>
<script> 
function smile() {
  var a;
...
//    pop(c);
    ...
    ctx.fillText("Wanna beat yourself?", myCanvas.width / 2, 270); 

  ...
  function render(){
    ...
    function htmlGameEnd (){
      ...
      if(  result !== RESULT.tie)
      {
        ...
        if (getPlayerName(result)!="Computer")
        {
        message1=getPlayerName(result)+" Won!"
        swal({
          title:message1,
          timer:4000,
          imageUrl:"win.jpg",
        ...
        beginGame();
          ...
          swal({
            title:"Computer Won, Lets try Again!",
            timer:4000,
            imageUrl:"tieface.jpg",
          })
          beginGame();
        }
      }
       ...
       {
            message="Its a Tie , Lets try again!!"
           swal({
             title:message,
             timer:4000,
             imageUrl:"tieface.jpg",
